...
*/
UCLASS()
class GAP_API UGravityMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	...
	*/
	UPROPERTY(Category = "Gravity Character Movement", BlueprintReadWrite, EditAnywhere)
...
protected:
	...
	*/
	UPROPERTY(Category = "Gravity Character Movement", VisibleAnywhere)
...
public:
	...
	*/
	UFUNCTION(Category = "Pawn|Components|GravityCharacterMovement", BlueprintCallable)
